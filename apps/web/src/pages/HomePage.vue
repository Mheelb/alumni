...
<template>
  ...
  <div v-else-if="!isLoggedIn" class="container flex flex-col items-center justify-center py-24 gap-8 text-center">
    <div class="flex flex-col items-center gap-4 max-w-xl">
      ...
      <p class="text-muted-foreground text-lg">
        AlumniManager centralise l'annuaire de vos diplômés, les événements et les offres d'emploi en un seul endroit.
      </p>
  ...
  <div v-else-if="isAdmin" class="container py-8 space-y-6">
    <div>
      ...
      <p class="text-muted-foreground text-sm mt-1">Tableau de bord — AlumniManager</p>
    </div>
    ...
    <template v-else-if="stats">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <!-- Derniers alumni créés -->
        <Card class="lg:col-span-2">
          <CardHeader>
            <CardTitle class="text-base">Derniers alumni créés</CardTitle>
          </CardHeader>
          <CardContent>
            <ul class="divide-y">
              <li
  ...
  <div v-else class="container py-8 space-y-6">
    <div>
      <h1 class="text-2xl font-bold tracking-tight">Bonjour, {{ firstName }}</h1>
      <p class="text-muted-foreground text-sm mt-1">Bienvenue sur la plateforme alumni</p>
    </div>
